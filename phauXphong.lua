...
local Tabs = {
	...
	Misc = Window:AddTab({ Title = "Một Số Chức Năng Khác", Icon = "list-plus" }),
	Credits = Window:AddTab({ Title = "Script Tạo Bởi FauXD!", Icon = "list-plus" }),
}
...
_G.FastAttack = true    
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Tự Động Farm Level", Default = false })
...
local Mastery = Tabs.Main:AddSection("Farm Trái Blox")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Chế Độ Farm Blox",
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Tự Động Farm Trái Blox", Default = false })
...
local MiscFarm = Tabs.Main:AddSection("Một Số Loại Farm Khác")
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Tự Động Đánh Cake Prince", Default = false })
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {Title = "Tự Động Spawn Boss Cake Prince", Default = true })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    local Material = Tabs.Main:AddSection("Farm Vật Liệu")
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Tự Động Farm Vật Liệu", Default = false })
